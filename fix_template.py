...
<div class="section">
  ...
  {% if alerts %}
  <table>
    <thead><tr><th>Severity</th><th>Rule</th><th>Source IP</th><th>Username</th><th>Description</th><th>Status</th><th>Time</th><th>Update</th></tr></thead>
    <tbody>
      {% for alert in alerts %}
      <tr>
  ...
  {% else %}<div class="empty">No alerts yet.</div>{% endif %}
</div>
<div class="section">
  <h2>Recent Log Entries (last 20)</h2>
  {% if recent_logs %}
  <table>
    <thead><tr><th>Time</th><th>Source</th><th>IP</th><th>User</th><th>Action</th><th>Details</th></tr></thead>
    <tbody>
  ...
  {% else %}<div class="empty">No log entries yet.</div>{% endif %}
</div>
</body>
</html>"""
